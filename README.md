...
- **2 giai đoạn**:
  - Enrollment: đăng ký khuôn mặt sinh viên
  - Attendance: điểm danh, theo dõi hiện diện, xuất báo cáo
...
- So khớp embedding với dữ liệu đã đăng ký
...
### 4.2.1 Mục tiêu
- Nhận diện nhiều sinh viên trong lớp theo thời gian thực
